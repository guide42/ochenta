...
class Request {
    ...
    function negotiateMediaType(array $available): array {
        return $this->negotiate($available, $this->getAcceptMediaType() ?: [],
    ...
    function negotiateCharset(array $available): array {
        return $this->negotiate($available, $this->getAcceptCharset() ?: [],
            function(string $available, string $acceptable): bool {
    ...
    function negotiateEncoding(array $available): array {
        return $this->negotiate($available, $this->getAcceptEncoding() ?: [],
            function(string $available, string $acceptable): bool {
                return $acceptable == '*' || !strcasecmp($acceptable, $available);
            });
    }
    ...
    function negotiateLanguage(array $available): array {
        return $this->negotiate($available, $this->getAcceptLanguage() ?: [],
            function(string $available, string $acceptable): bool {
     ...
     */
    private function negotiate(array $available, array $acceptable, callable $match): array {
