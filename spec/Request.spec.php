...
describe('Request', function() {
    ...
    describe('->negotiateMediaType', function() {
        it('returns empty list when available list is empty', function() {
            ...
            expect($req->negotiateMediaType([]))->toBe([]);
        });
        ...
        it('returns all available when accept is empty', function() {
            ...
            expect($req->negotiateMediaType($available))->toEqual($available);
        });
        ...
        it('throws UnexpectedValueException when accept media type has no separator', function() {
            ...
            expect(function() use($req) {
                $req->negotiateMediaType(['application/json']);
            })->toThrow(new UnexpectedValueException);
        });
        ...
        it('returns matched when accept base type is asterisk and sub type equals', function() {
            ...
            $mediaTypes = $req->negotiateMediaType(['application/json']);
        ...
        it('returns matched when accept vendor sub type is asterisk', function() {
            ...
            $mediaTypes = $req->negotiateMediaType(['application/vnd.example+json']);
        ...
        it('returns empty list when none matched', function() {
            ...
            expect($req->negotiateMediaType(['application/zip']))->toBe([]);
        });
    });

    describe('->negotiateCharset', function() {
        it('returns empty list when available list is empty', function() {
            $req = new Request('GET', '/', [
                'host' => 'example.com',
                'accept-charset' => 'utf-8',
            ]);
            expect($req->negotiateCharset([]))->toBe([]);
        });
        ...
        it('returns all available when accept is empty', function() {
            ...
            $available = ['utf-8'];
            expect($req->negotiateCharset($available))->toEqual($available);
        });
        ...
        it('returns matched accept charset is asterisk', function() {
            ...
            $charsets = $req->negotiateCharset(['utf-8']);
        ...
        it('returns NULL when none matched', function() {
            ...
            $charsets = $req->negotiateCharset(['US-ASCII']);
            expect(array_shift($charsets))->toBe(NULL);
        });
    });

    describe('->negotiateEncoding', function() {
        it('returns empty list when available list is empty', function() {
            $req = new Request('GET', '/', [
                'host' => 'example.com',
                'accept-encoding' => 'compress',
            ]);
            expect($req->negotiateEncoding([]))->toBe([]);
        });
        ...
        it('returns all available when accept is empty', function() {
            ...
            $available = ['compress'];
            expect($req->negotiateEncoding($available))->toEqual($available);
        });
        ...
        it('returns matched accept charset is asterisk', function() {
            ...
            $encodings = $req->negotiateEncoding(['compress']);
        ...
        it('returns empty list when none matched', function() {
            ...
            $encodings = $req->negotiateEncoding(['deflate']);
            expect($encodings)->toBe([]);
        });
    });

    describe('->negotiateLanguage', function() {
        it('returns empty list when available list is empty', function() {
            $req = new Request('GET', '/', [
                'host' => 'example.com',
                'accept-language' => 'en',
            ]);
            expect($req->negotiateLanguage([]))->toBe([]);
        });
        ...
        it('returns all available when accept is empty', function() {
            ...
            $available = ['en'];
            expect($req->negotiateLanguage($available))->toEqual($available);
        });
        ...
        it('returns matched when accept base lang is asterisk and sub lang equals', function() {
            ...
            $languages = $req->negotiateLanguage(['en-US']);
        ...
        it('returns matched when lang equals', function() {
            ...
            $languages = $req->negotiateLanguage(['en']);
        ...
        it('returns empty list when none matched', function() {
            ...
            expect($req->negotiateLanguage(['es-AR']))->toBe([]);
        });
    });
});